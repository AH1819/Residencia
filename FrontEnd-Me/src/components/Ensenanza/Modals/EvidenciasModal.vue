...
export default {
  ...
  watch: {
    showModal(newVal) {
      if (newVal) {
        this.$nextTick(() => {
          this.obtenerData()
          this.form.idEnsenanza = this.ensenanzaId
        })
      }
    }
  },
  ...
  methods: {
    obtenerData() {
      apiEnsenanza
        .obtenerEvidencias(this.ensenanzaId)
        .then((response) => {
    ...
    submitForm() {
      if (this.archivo) {
        ...
        formData.append('idEvidenciasE', this.form.idEvidencia)
        formData.append('idActEnsenanza', this.form.idEnsenanza)
        ...
        if (!this.form.idEvidencia) {
          ...
          promise = apiEnsenanza.actualizarEvidencias(this.form.idEvidencia, formData)
        }
