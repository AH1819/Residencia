...
export default {
  ...
  methods: {
    obtenerData() {
      ...
      apiInvestigacion
        .obtenerEvidencias(this.projectId)
        .then((response) => {
      ...
      if (this.archivo) {
        ...
        apiInvestigacion
          ...
          .then(() => {
            Swal.fire(
              'Evidencia agregada',
              'La evidencia ha sido agregada correctamente.',
              'success'
            )
            this.obtenerData()
            this.resetForm()
          ...
          .catch((error) => {
            ...
            Swal.fire('Error', 'Error al agregar la evidencia.', 'error')
          })
      } else {
        Swal.fire('Archivo no seleccionado', 'Por favor seleccione un archivo.', 'warning')
      }
    },
