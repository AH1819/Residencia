        ...
        <form class="mt-2" @submit.prevent="login" method="POST">
          <div>
            ...
            <input
              ...
              autofocus type="text" placeholder="RFC" id="rfc" v-model="rfc" />
          </div>
          ...
          <div class="mt-4">
            ...
            <input
              class="w-full px-2 py-2 rounded-lg bg-gray-100 border focus:border-SecundaryGold focus:bg-white focus:outline-none"
              type="password" placeholder="Contraseña" id="password" v-model="password" />
          </div>

          <div class="text-right mt-2">
            <a href="#"
              class="text-sm font-semibold text-gray-700 hover:text-SecundaryGold focus:text-blue-700">¿Olvidaste tu
              contraseña?</a>
          </div>
