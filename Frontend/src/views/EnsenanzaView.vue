  ...
  <div class="container mx-auto">
    ...
    <div
      ...
      <div class="w-2/3 m-5">
        ...
        <Multiselect v-model="selMateria" :options="materias" label="nombreMateria" track-by="materia"
          placeholder="Selecciona una materia" @select="actualizarContenido" class="" />
      </div>
    </div>
...
export default {
  ...
  mounted() {
    this.$store.dispatch("setSelectedOption", "Gestion Enseñanza - Aprendizaje");
